 ...
 *  2018/9/11.
 */
class RoundRectDrawableWithShadow(cardViewDelegate: CardViewDelegate, resources: Resources, backgroundColor: ColorStateList, radius: Float, shadowSize: Float, maxShadowSize: Float, direction: Int, cornerVisibility: Int, startColor: Int, endColor: Int) : Drawable() {
    ...
    * */
    ...
    private var mCardDelegate: CardViewDelegate
